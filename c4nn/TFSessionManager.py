...
class TFSessionManager:
    ...
    @classmethod
    def save_session(cls, model_name):
        # Add ops to save and restore all the variables.
        saver = tf.train.Saver()
        saver.save(TFSessionManager.session, '{}.ckpt'.format(model_name))

    @classmethod
    def load_session(cls, model_name):
        # Add ops to save and restore all the variables.
        saver = tf.train.Saver()
        saver.restore(TFSessionManager.session, '{}.ckpt'.format(model_name))
